...
const Header = () => {
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto flex flex-col items-center justify-center gap-4 md:py-[10%] sm:py-[20%] mb-40">
        <div>
        ...
        <p className = "max-w-2xl mx-auto font-Ovo">I'm a passionate data scientist and creative soul from Poland. I specialize in data analysis and machine learning, currently I want to combine this knwoledge with digital content creation. I'm always eager to learn new things.</p>
